<template>
    <div class="pagination">
        ...
        <button class="button" id="prev" disabled>
          <i class='bx bx-chevron-left' style="font-size:20px"></i>
        </button>
        <div class="links">
          <a href="#" ref="page-nums" class="page-link active" >1</a>
          <a href="#" ref="page-nums" class="page-link">2</a>
          <a href="#" ref="page-nums" class="page-link">3</a>
          <a href="#" ref="page-nums" class="page-link">4</a>
          <a href="#" ref="page-nums" class="page-link">5</a>
        </div>
        <button class="button" id="next">
          <i class='bx bxs-chevron-right' style="font-size:20px"></i>
        </button>
        <button class="button" id="endBtn">
          <i class='bx bxs-chevrons-right' style="font-size:20px"></i>
        </button>
      </div>
</template>
<script>
